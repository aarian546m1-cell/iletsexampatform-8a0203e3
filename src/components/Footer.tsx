      ...
      <div className="container py-12">
        <div className="grid gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><span className="text-foreground/70">Listening</span></li>
              <li><span className="text-foreground/70">Reading</span></li>
              <li><span className="text-foreground/70">Writing</span></li>
              <li><span className="text-foreground/70">Speaking</span></li>
            </ul>
          </div>
          <div>
